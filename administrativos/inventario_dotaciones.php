...
include('php/e_inventario_dotaciones.php');
?>
...
<head>
  ...
  <title>Inventario de dotaciones Satel Importadores</title>
 ...
 <script src="js/menu.js"></script>
  <script type="text/javascript" src="js/inventario_dotaciones.js"></script>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="item form-group">
                                <div class="control-label col-md-3 col-sm-3 col-xs-12"></div>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div id="tipos">
                                              <!-- Se carga por ajax descripción cantidad consulta_dotaciones.php?ref=Guantes -->
                                            </div>
                                  </div>
                          </div>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="item form-group">
                               ...
                               <div class="item form-group">
                                    ...
                                    <label for="lista" class="control-label col-md-3 col-sm-3 col-xs-12">Talla:</label>
                                    
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input required type="text"  name="tal" class="form-control">
                                    </div>
...
<!-- Usuarios -->
  ...
  <script src="js/usuarios_ver.js"></script>
