...
<head>
  ...
  <title>Ceder clientes Satel Importadores</title>
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>
                    Ceder clientes
                    <small>
                        Cambiar de asesor a un cliente:
                    </small>
                </h3>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Pendientes por autorización</h1></div></div></div> 
<!-- CEDER -->
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">

                  <h2>Pendientes por autorizar:
                   </strong><small>
                   </small></h2>
                  ...
                  <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title">ID origen</th>
                        <th class="column-title">Origen</th>
                        <th class="column-title">Cliente COD</th>
                        <th class="column-title">Cliente</th>
                        <th class="column-title">ID destino</th>
                        <th class="column-title">Destino</th>
                        <th class="column-title">Aprobar</th>
                        </th>
                    ...
                    <tbody class="tabla_ceder">
                      

                      <!-- datos llegan por jquery -->
...
<!-- modal autorizar transalado -->
  ...
  <script src="js/ceder_clientes.js"></script>
