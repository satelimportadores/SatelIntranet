...
<?php
  ...
  include_once('php/consultas_index02.php');
...
<div class="row"><div class="col-md-12 col-md-offset-5 col-xs-offset-5"><h2>Pedidos</h2></div></div>
        ...
        <div class="row tile_count">
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-12 tile_stats_count">
            <div class="left"></div>
            <div class="right">
              <span class="count_top"><i class="fa fa-file-powerpoint-o"></i> Total pedidos</span>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-12 tile_stats_count">
            ...
            <div class="right">
              ...
              <a href="guias.php"><div class="count"><?php echo $Cpedidospendientes ?></div></a>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-12 tile_stats_count">
            ...
            <div class="right">
              ...
              <a href="recibidos.php"><div class="count"><?php echo $Cpedidos; ?></div></a>
              <!-- <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span> -->
            </div>
          </div>
        ...
        <div class="row tile_count">
          ...
          <div class="animated flipInY col-md-3 col-sm-4 col-xs-12 tile_stats_count">
            ...
            <div class="right">
              ...
              <a href="domicilios.php"><div class="count"><?php echo $Cdomicilio; ?></div></a>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <div class="row x_title">
              <h3>
              <div id="impmes" class="col-md-12 col-md-offset-5 col-xs-12 col-xs-offset-3">Pedidos del mes </div>
              </h3>
              </div>
              </div>
                <div>
              ...
              <br>
                            ...
                            <div class="row">
              <div class="row x_title"><h3><div id="impmes" class="col-md-12 col-md-offset-4 col-xs-12 col-xs-offset-1"><strong>Gráfica Anual </strong> Total de pedidos <i class="fa fa-file-powerpoint-o blue"></i> 
              </div></h3>
              </div>
              </div>
...
?>
  ...
  <script>
    ...
    $(document).ready(function() {
        moment.locale('es');
        var mesactual = moment().format('MMMM');
        $('#impmes').html('Pedidos de: '+ mesactual+' <i class="fa fa-file-powerpoint-o blue"></i>');
    ...
    var data = {
      ...
      datasets: [{
        ...
        //traer encargados de alistamiento GRAP:
             ...
             $sql01 = "select count(`irp`.`encargado_alistamiento`) AS `cant`,(select count(`intranet_registro_pedido`.`encargado_alistamiento`) from `intranet_registro_pedido` where ((`intranet_registro_pedido`.`encargado_alistamiento` is not null) and (date_format(`intranet_registro_pedido`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m')))) AS `total` from `intranet_registro_pedido` `irp` where ((`irp`.`encargado_alistamiento` is not null) and (date_format(`irp`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m'))) group by `irp`.`encargado_alistamiento` order by count(`irp`.`encargado_alistamiento`) desc";
...
//traer color encargados de alistamiento GRAP:
 ...
 $sql01 = "select `irp`.`encargado_alistamiento` AS `nombre`,count(`irp`.`encargado_alistamiento`) AS `cant`,(select `iu`.`colorhex` from `intranet_usuarios` `iu` where (`irp`.`encargado_alistamiento` = convert(`iu`.`nombre` using utf8)) limit 1) AS `hexcolor` from `intranet_registro_pedido` `irp` where ((`irp`.`encargado_alistamiento` is not null) and (date_format(`irp`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m'))) group by `irp`.`encargado_alistamiento` order by count(`irp`.`encargado_alistamiento`) desc";
...
//traer color encargados de alistamiento GRAP:
  $alistograpcolor01 = new Conexion;
 $sql01 = "select count(`irp`.`encargado_alistamiento`) AS `cant`,(select `iu`.`colorhex` from `intranet_usuarios` `iu` where (`irp`.`encargado_alistamiento` = convert(`iu`.`nombre` using utf8)) limit 1) AS `hexcolor` from `intranet_registro_pedido` `irp` where ((`irp`.`encargado_alistamiento` is not null) and (date_format(`irp`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m'))) group by `irp`.`encargado_alistamiento` order by count(`irp`.`encargado_alistamiento`) desc";
 $Ralistograpcolor01 = $alistograpcolor01->query($sql01) or trigger_error($alistograpcolor01->error);
 $alistograpcolor01->close();
  
//traer color encargados de alistamiento GRAP:
 while ($r = $Ralistograpcolor01->fetch_array()) {
...
//traer color encargados de revision GRAP:
 ...
 $sql01 = "select `irp`.`encargado_revision` AS `nombre`,(select `iu`.`colorhex` from `intranet_usuarios` `iu` where (`irp`.`encargado_revision` = convert(`iu`.`nombre` using utf8)) limit 1) AS `colorhex` from `intranet_registro_pedido` `irp` where (date_format(`irp`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m')) group by `irp`.`encargado_revision` order by count(`irp`.`encargado_revision`) desc";
...
//traer color encargados de revision GRAP:
  $revisograpcolor01 = new Conexion;
 $sql01 = "select (select `iu`.`colorhex` from `intranet_usuarios` `iu` where (`irp`.`encargado_revision` = convert(`iu`.`nombre` using utf8)) limit 1) AS `colorhex` from `intranet_registro_pedido` `irp` where (date_format(`irp`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m')) group by `irp`.`encargado_revision` order by count(`irp`.`encargado_revision`) desc";
 $Rrevisograpcolor01 = $revisograpcolor01->query($sql01) or trigger_error($revisograpcolor01->error);
 $revisograpcolor01->close();
  
//traer color encargados de revision GRAP:
 while ($r = $Rrevisograpcolor01->fetch_array()) {
