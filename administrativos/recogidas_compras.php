...
<head>
  ...
  <title>Recogidas pendientes Satel Importadores</title>
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>
                    ...
                    <small>
                        Lista de recogidas pendientes Satel Importadores
                    </small>
                </h3>
            </div>
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            ...
            <input type="text" name="compra" class="form-control" placeholder="Buscar compras ...">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Resumen de recogidas pendientes</h1></div></div></div> 
<!-- PEDIDOS -->
...
?>
                  <h2>Recogidas pendientes
                   </strong><small><?php echo $Nrecogidas; ?>
                   </small></h2>
