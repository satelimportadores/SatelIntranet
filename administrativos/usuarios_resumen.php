      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-5"><h1>Usuarios</h1></div></div></div> 
<!-- usuarios -->
              ...
              <table class="table table-striped responsive-utilities jambo_table bulk_action" id="clientes">
                    <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title">Des/Activar</th>
                         </tr>
                    </thead>
                     <!-- datos llegan por jquery js/usuarios_resumen.js -->
                     <!-- datos llegan por jquery php/usuarios_resumen.php -->
              </table>
...
<!-- modal resetear tareas -->
  ...
  <script src="js/usuarios_resumen.js"></script>
