...
<head>
  ...
  <title>Resumen de pedidos revisados Satel Importadores</title>
...
<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Resumen de pedidos revisados del <strong class="green">mes</strong></h1></div></div></div> 
...
//traer pedidos del usuario
  ...
  $sql01 = "select count(`intranet_registro_pedido`.`id`) AS `cantidad`,`intranet_registro_pedido`.`encargado_revision` AS `encargado_revision` from `intranet_registro_pedido` where ((`intranet_registro_pedido`.`encargado_revision` <> '') and (date_format(`intranet_registro_pedido`.`fecha`,'%Y-%m') = date_format(now(),'%Y-%m'))) group by `intranet_registro_pedido`.`encargado_revision` order by count(`intranet_registro_pedido`.`id`) desc";
...
if ($Ntareamess >= '1') {
        //imprimir los registros
            ...
            while ($t=$tareamess->fetch_array()) {
                ...
                echo "</td>";
                echo "<td class=' '>$t[encargado_revision]</td>";
 ...
 ?>
                          ...
                          <tr>
                              <td></td>
                              <td>Total de pedidos revisados:</td>
...
<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-2"><h1>Resumen de pedidos revisados del <strong class="green">mes anterior</strong></h1></div></div></div> 
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <?php 
...
//traer pedidos del usuario
  ...
  $sql01 = "select count(`intranet_registro_pedido`.`id`) AS `cantidad`,`intranet_registro_pedido`.`encargado_revision` AS `encargado_revision` from `intranet_registro_pedido` where ((`intranet_registro_pedido`.`encargado_revision` <> '') AND YEAR(fecha) = YEAR(CURDATE()) and (month(fecha) = month((curdate() + interval -(1) month)))) group by `intranet_registro_pedido`.`encargado_revision` order by count(`intranet_registro_pedido`.`id`) desc";
...
if ($Ntareamessant >= '1') {
        //imprimir los registros
            ...
            while ($s=$tareamessant->fetch_array()) {
                ...
                echo "<input type='checkbox' class='flat' name='table_records'>";
                echo "</td>";
                echo "<td class=' '>$s[encargado_revision]</td>";
...
<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Resumen de pedidos revisados del <strong class="green">año</strong></h1></div></div></div> 
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <?php 
...
//traer pedidos del usuario
  ...
  $sql01 = "select count(`intranet_registro_pedido`.`id`) AS `cantidad`,`intranet_registro_pedido`.`encargado_revision` AS `encargado_revision` from `intranet_registro_pedido` where YEAR(fecha) = YEAR(CURDATE()) AND ((`intranet_registro_pedido`.`encargado_revision` <> '')) group by `intranet_registro_pedido`.`encargado_revision` order by count(`intranet_registro_pedido`.`id`) desc";
...
if ($Ntareamano >= '1') {
        //imprimir los registros
            ...
            while ($u=$tareamano->fetch_array()) {
                ...
                echo "<input type='checkbox' class='flat' name='table_records'>";
                echo "</td>";
                echo "<td class=' '>$u[encargado_revision]</td>";
