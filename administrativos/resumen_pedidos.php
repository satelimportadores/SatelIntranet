...
<head>
  ...
  <title>Resumen de pedidos Satel Importadores</title>
...
<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Resumen de pedidos realizados del <strong class="green">mes</strong></h1></div></div></div> 
...
if ($Ntareamess >= '1') {
        //imprimir los registros
            ...
            while ($t=$tareamess->fetch_array()) {
                ...
                $t['promedio'] = number_format($t['promedio']);
                echo "<td class=' '><strong class='red'>$ $t[promedio]</strong></td>";
                $totalpedidos = $totalpedidos + $t['total'];
                $t['total'] = number_format($t['total']);
                echo "<td class=' '><strong class='green'>$ $t[total]</strong></td>";
                echo '</td>';
                echo "</tr>";
 ...
 ?>
                    ...
                    echo "<td class=' '><strong>Total de pedidos:</strong></td>";
                    echo "<td class=' '><strong class='green'>$ $totalpedidos</strong></td>";
                      echo '</tr>';
...
<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-2"><h1>Resumen de pedidos realizados del <strong class="green">mes anterior</strong></h1></div></div></div> 
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <?php 
...
if ($Ntareamessant >= '1') {
        //imprimir los registros
            ...
            while ($s=$tareamessant->fetch_array()) {
                ...
                $s['promedio'] = number_format($s['promedio']);
                echo "<td class=' '><strong class='red'>$ $s[promedio]</strong></td>";
                $totalpedidosant = $totalpedidosant + $s['total'];
                $s['total'] = number_format($s['total']);
                echo "<td class=' '><strong class='green'>$ $s[total]</strong></td>";
                echo '</td>';
                echo "</tr>";
 ...
 ?>
                    ...
                    echo "<td class=' '></td>";
                    echo "<td class=' '></td>";
                    $totalpedidosant = number_format($totalpedidosant);
                    echo "<td class=' '><strong>Total de pedidos:</strong></td>";
                    echo "<td class=' '><strong class='green'>$ $totalpedidosant</strong></td>";
                      echo '</tr>';
...
<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Resumen de pedidos realizados del <strong class="green">año</strong></h1></div></div></div> 
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <?php 
...
if ($Ntareamano >= '1') {
        //imprimir los registros
            ...
            while ($u=$tareamano->fetch_array()) {
                ...
                echo "<input type='checkbox' class='flat' name='table_records'>";
                echo "</td>";
                echo "<td class=' '>$u[user_id]</td>";
                echo "<td class=' '>$u[nombre]</td>";
                echo "<td class=' '>$u[apellido]</td>";
                echo "<td class=' '><strong class='red'> $u[cantidad]</strong></td>";
                $u['promedio'] = number_format($u['promedio']);
                echo "<td class=' '><strong class='red'>$ $u[promedio]</strong></td>";
                $totalpedidosano = $totalpedidosano + $u['total'];
                $u['total'] = number_format($u['total']);
                echo "<td class=' '><strong class='green'>$ $u[total]</strong></td>";
                echo '</td>';
                echo "</tr>";
 ...
 ?>
                    ...
                    echo "<td class=' '></td>";
                    echo "<td class=' '></td>";
                    $totalpedidosano = number_format($totalpedidosano);
                    echo "<td class=' '><strong>Total de pedidos:</strong></td>";
                    echo "<td class=' '><strong class='green'>$ $totalpedidosano</strong></td>";
                      echo '</tr>';
