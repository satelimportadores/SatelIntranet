...
<!-- GUIAS -->
  ...
  $compras = $compra->query($sql02) or trigger_error($compra->error);
  $Ncompras = $compra->affected_rows;
  //echo $Nguias;
  //echo '</br>';
  $compra->close();
//traer compras del usuario
...
?>
                  <h2>Compras encontradas: <small><?php echo $Ncompras; ?></small></h2>
