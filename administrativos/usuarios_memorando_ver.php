...
<head>
  ...
  <title>Ver memorandos de empleados</title>
 ...
 <script src="js/menu.js"></script>
  <script src="js/usuarios_memorando_ver.js"></script>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                <div class="x_title">
                  <h2>Ver memorandos entregados a los trabajadores</h2>
                  ...
                  <form id="demo-form2" data-parsley-validate novalidate class="form-horizontal form-label-left" method="GET" action="php/e_usuarios_entrega_dotacion.php">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single form-control" required="" id="empleados" tabindex="-1" name="empleados">
                                ...
                                <!-- LLega los empleados por ajax php/consulta_usuarios_memorandos-->
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                              <div class="load">
                                  <i class="fa fa-spinner fa-spin fa-3x fa-fw green"></i>
                             </div>
                        <thead>
                          <tr class="headings">
                        ...
                        <tbody id="dataciones">
                          ...
                          <!-- Llega por ajax desde php/consulta_usuarios_memorandos_detalle.php -->
