...
//consulta maximo
 ...
 $sql02 = "SELECT COUNT(id_cliente) as clientemax FROM intranet_actualizacion_clientes WHERE cliente_nuevo = 1";
...
//traer registro de cliente
  ...
  $sql03 = "SELECT *  FROM intranet_actualizacion_clientes WHERE cliente_nuevo = 1 LIMIT $limit,1";
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                ...
                <!-- formulario de actualizacion de clientes -->
                  ...
                  <form id="demo-form2" novalidate class="form-horizontal form-label-left" data-parsley-validate method="POST" action="php/e_clientes_asesor.php">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="persona_contacto"  name="persona_contacto" value="<?php echo $r['persona_contacto']; ?>" placeholder="Pepito Pérez" class="form-control col-md-7 col-xs-12 has-feedback-left text-uppercase">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single form-control" tabindex="-1" name="ciudad_new">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="direccion" name="direccion" value="<?php echo $r['direccion']; ?>"   placeholder="Calle 13 # 26 - 57" class="form-control col-md-7 col-xs-12 has-feedback-left">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="telefono" name="telefono"  value="<?php echo $r['telefono']; ?>"  placeholder="3603299" class="form-control col-md-7 col-xs-12 has-feedback-left">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" id="email_new" name="email_new" value="<?php echo $r['email_new']; ?>" placeholder="ventas@satelimportadores.com" class="form-control col-md-7 col-xs-12 has-feedback-left">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control select2_single select2_single01" name="sector">
                          <option value="">Seleccione</option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="item col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_group form-control"  name="forma_pago">
                        ...
                        <select class="select2_single02 form-control" required="" tabindex="-1" name="id">
                          ...
                          <?php 
                              ...
                              if ( $r['user_id'] != '') {
                                    ...
                                    $buscarid = $r['user_id'];
                                    $asesores01 = new Conexion;
                                    $sql04 = "SELECT * FROM intranet_usuarios WHERE id = \"$buscarid\"";
                                    $Rasesores01 = $asesores01->query($sql04) or trigger_error($asesores01->error);
                                    $t=$Rasesores01->fetch_array();

                                echo "<option value='$t[id]' selected='selected'>$t[nombre] $t[apellido]</option>";
                              }
              ...
              <div class="col-md-7">
                          <div class="bs-glyphicons">
                                 ...
                                 <ul class="bs-glyphicons-list">
                                    <a href="clientes_asesor.php?pagina=pinicial">
                                      <li>
                                      ...
                                      <a href="clientes_asesor.php?pagina=panterior&nregistro=<?php echo $limit; ?>">  
                                      <li>
                                        <span class="glyphicon glyphicon-step-backward" aria-hidden="true"></span>
                                        <span class="glyphicon-class">Registro Anterior</span>
                                      </li>
                                      </a>
                                      <a href="clientes_asesor.php?pagina=psiguiente&nregistro=<?php echo $limit; ?>">
                                          <li>
                                            <span class="glyphicon glyphicon-step-forward" aria-hidden="true"></span>
                                            <span class="glyphicon-class">Siguiente Registro</span>
                                          </li>
                                      </a>
                                      <a href="clientes_asesor.php?pagina=pfinal">
                                          <li>
