...
<head>
  ...
  <title>Domicilios pendientes Satel Importadores</title>
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>
                    ...
                    <small>
                        Lista de domicilios realizados Satel Importadores
                    </small>
                </h3>
            </div>
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Resumen de domicilios realizados</h1></div></div></div> 
<!-- PEDIDOS -->
...
//traer pedidos del usuario
  ...
  $domicilios = $domicilio->query($sql01) or trigger_error($domicilio->error);
  $Ndomicilios = $domicilio->affected_rows;
  $domicilio->close();
//traer pedidos del usuario

?>
                  <h2>Domicilios Realizadas
                   </strong><small><?php echo $Ndomicilios; ?>
                   </small></h2>
...
if ($Ndomicilios >= '1') {
        //imprimir los registros
            ...
            while ($r=$Domicilios->fetch_array()) {
