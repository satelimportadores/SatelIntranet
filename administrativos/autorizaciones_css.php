...
<head>
  ...
  <title>Autorizaciones CSS Satel Importadores</title>
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>
                    Autorizaciones CSS
                    <small>
                        Visualización en los menú de los usuarios.
                    </small>
                </h3>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-4"><h1>Autorizaciones</h1></div></div></div> 
<!-- CEDER -->
                  ...
                  <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title">Cambiar estado</th>
                        </th>
                    ...
                    <tbody class="tabla_autcss">
                      

                      <!-- datos llegan por jquery /php/consulta_css_autorizaciones.php-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="form1" action="">
        ...
        <h4 class="modal-title" id="myModalLabel">Habilitar Vista</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="save()" class="btn btn-primary">Sí</button>
      </div>
      </form>
    </div>
  </div>
...
<!-- modal autorizar transalado -->
  ...
  <script src="js/autorizaciones_css.js"></script>
