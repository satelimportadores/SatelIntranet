...
<head>
 ...
 <script src="js/usuarios_entrega_dotacion.js"></script>
...
<body class="nav-md">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                <div class="x_title">
                  <h2>Formulario de entrega de dotación a trabajadores  </h2>
                ...
                <!-- formulario de actualizacion de clientes -->
                  ...
                  <form id="demo-form2" data-parsley-validate novalidate class="form-horizontal form-label-left" method="GET" action="php/e_usuarios_entrega_dotacion.php">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="referencias form-control" required="" id="referencias" tabindex="-1" name="referencias">
                          

                                <!-- LLega los empleados por ajax consulta_referencias_dotacion-->
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action" >
                        ...
                        <tbody id="dataciones">
                          ...
                          <!-- Llega por ajax desde consulta_inventario_dotaciones -->
  ...
  <script>
    $(document).ready(function() {
          ...
          $( "#empleados" ).load( "php/consulta_usuarios_bodega.php" );
          //cargar empleados  de bodega
          //cargar inventario de dotaciones
          $( "#dataciones" ).load( "php/consulta_inventario_dotaciones.php" );
          //cargar inventario de dotaciones
          //cargar inventario de dotaciones
          $( "#referencias" ).load( "php/consulta_referencias_dotacion.php" );
          //cargar inventario de dotaciones
