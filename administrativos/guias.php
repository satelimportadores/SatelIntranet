...
<head>
  ...
  <title>Guías pendientes Satel Importadores</title>
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>
                    Pendientes de guía
                    <small>
                        Lista de pendientes por guía Satel Importadores
                    </small>
                </h3>
            </div>
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel"><div class="col-md-12 col-xs-12 col-md-offset-3"><h1>Pendientes por guía</h1></div></div></div> 
<!-- PEDIDOS -->
...
?>
                  <h2>Pendientes por guías encontradas:
