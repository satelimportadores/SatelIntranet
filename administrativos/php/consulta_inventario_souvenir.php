<?php 
    ...
    include_once('class.conexion.php');
      ...
      if (isset($_REQUEST['souvenir'])) {
          ...
          $sql03 = "SELECT * FROM intranet_souvenir_inventario WHERE cantidad > 0 ORDER BY referencia ASC";
