...
if (isset($_REQUEST['enviar'])) {
	...
	$query = "UPDATE intranet_dotaciones_inventario SET cantidad = cantidad+$num WHERE referencia = '$referencia' && id = '$descripcion'";
...
if (isset($_REQUEST['restar'])) {
	...
	$num = $_REQUEST['num'];
	$inventario = new Conexion;
	$query = "SELECT cantidad from intranet_dotaciones_inventario where referencia = '$referencia' && id = '$descripcion'";
	$result = $inventario->query($query) or trigger_error($inventario->error);
