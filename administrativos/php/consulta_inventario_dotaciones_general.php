...
if (isset($_REQUEST['user_id'])) {
  ...
  //traer inventario de dotaciones general 
      ...
      while ($s = $Rdotacion->fetch_array()) {
                ...
                echo "<td class=' '><a target='_blank' href='usuarios_entrega_dotacion_discriminado.php?user_id=$s[user_id]&fecha=$s[fecha]'><i class='fa fa-search-plus green'></i></a></td>";
               ...
               if ($post_imagen == '') {
                 echo "<td class=' '><a href='#myModal' data-toggle='modal' id='ceder' role='button' data-codigo-id='$user_id' data-fecha-id='$fecha' class='btn btn-primary' target='_blank'>+ Imagen</a></td>";
               }else{
