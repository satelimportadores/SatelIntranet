          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                ...
                <!-- DATA TABLE clientes consulta_clientes.js -->
                      <div class="cargando"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></div>
                      <table class="table table-striped table-bordered table-hover dataTable no-footer" id="clientes">
                ...
                <!-- DATA TABLE clientes js/consulta_clientes.js -->
