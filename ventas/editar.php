                ...
                <!-- formulario de actualizacion de clientes -->
                  ...
                  <form id="demo-form2" novalidate data-parsley-validate class="form-horizontal form-label-left" method="POST" action="php/e_editar.php">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="persona_contacto" name="persona_contacto" value="<?php echo $r['persona_contacto']; ?>" placeholder="Pepito Pérez" data-parsley-minlength="4" required="required" class="form-control col-md-7 col-xs-12 has-feedback-left">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="telefono" name="telefono"  data-parsley-minlength="7"  value="<?php echo $r['telefono']; ?>" required="required" placeholder="3603299" class="form-control col-md-7 col-xs-12 has-feedback-left">
