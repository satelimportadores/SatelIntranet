        ...
        <div class="row tile_count">
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-10 tile_stats_count">
            ...
            <div class="right">
              ...
              <div class="count"><?php echo ($tareas_mes * 100);  ?> %</div>
               <span class="count_bottom">
              <?php
                if ($tareas_mesant > 0) {
                 echo "<i class='green'><i class='fa fa-sort-asc'></i>";
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <div class="row"><div class="row x_title"><h3><div id="impmes" class="col-md-12 col-md-offset-3 col-xs-12 col-xs-offset-1">Total de llamadas <i class="fa fa-phone green"></i> - Total de pedidos <i class="fa fa-file-powerpoint-o blue"></i> </div></h3></div></div>
...
//traer datos para canvas de grafica llamadas
      ...
      $sql01 = "SELECT YEAR(fecha) as year, MONTH(fecha) as mes, DAY(fecha) as dia, COUNT(id) as cant FROM intranet_actualizacion_clientes_comentarios WHERE DATE_FORMAT(fecha,'%Y-%m') = DATE_FORMAT(NOW(),'%Y-%m') AND user_id = \"$user_id\" GROUP BY dia";
...
//traer datos para canvas de grafica pedidos
      ...
      $sql01 = "SELECT YEAR(fecha) as year, MONTH(fecha) as mes, DAY(fecha) as dia, COUNT(id) as cant FROM intranet_registro_pedido WHERE DATE_FORMAT(fecha,'%Y-%m') = DATE_FORMAT(NOW(),'%Y-%m') AND user_id = \"$user_id\" GROUP BY dia";
