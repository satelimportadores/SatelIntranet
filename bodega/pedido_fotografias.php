 ...
 <script src="js/menu.js"></script>
   ...
   <script>
        ...
        $( document ).ready(function() {
            $( "#imagenes" ).load( "php/consulta_pedido_fotografias.php?numero_pedido=<?php echo $numero_pedido; ?>" );
        });
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Fotografias de pedidos</h3>
            </div>

              <form action="pedido_fotografias.php" method="GET">
            <div class="title_right">
              <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <div class="input-group">
                
                  <input type="text" name="numero_pedido" class="form-control" placeholder="Buscar...">
