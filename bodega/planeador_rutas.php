...
<?php
  ...
  include_once('php/consulta_planeador_rutas.php');
...
if ($Nguias >= '1') {
        //imprimir los registros
            ...
            while ($r=$guias->fetch_array()) {
                ...
                echo "<td class=' '>$r[medio_transporte]</td>";
                ...
                echo "<td class=' '>$r[zona]</td>";
                    ...
                    if ($r['entransito'] == '') {
                      echo "<td>";
                      print '<input type="checkbox" name="check01">';
                      echo "</td>";
                    }else{
                      echo "<td>";
                    ...
                    if ($r['entregado'] == '') {
                      echo "<td>";
                      print "<input type='checkbox' name='check02'>";
                      echo "</td>";
                    }else{
                      echo "<td>";
                      echo "<input type='checkbox' checked='checked'>";
