...
<?php 
 ...
 $sql01 = "SELECT * FROM intranet_orden_compra WHERE t_entrega = 'Recogida' AND entransito = 1 AND entregado = 1 AND recepcion_mercancia IS NULL";
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Registro recepción de mercancía por recogida</h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                ...
                <!-- formulario de actualizacion de clientes -->
                  ...
                  <form id="demo-form2"  data-parsley-validate novalidate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="php/e_registro_recepcion_recogida.php">
                    ...
                    <div class="numero_pedido">
                     ...
                     <div class="item form-group">
                      <label for="N_encargado" class="control-label col-md-3 col-sm-3 col-xs-12">Nombre encargado recogida</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single02 form-control" required="" id="N_encargado" name="N_encargado">

                          <option value="">Seleccione</option>
                           <?php 
                                  while ($z=$Rbodega02->fetch_array()) {
                  ...
                  <div class="item form-group">
                      <label for="N_revision" class="control-label col-md-3 col-sm-3 col-xs-12">Nombre encargado recepción</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single03 form-control" required="" id="N_revision" name="N_revision">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".select2_single02").select2({
        placeholder: "Seleccione encargado de la recogida"
      });
