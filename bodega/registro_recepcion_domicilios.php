...
<?php 
 ...
 $sql01 = "SELECT * FROM intranet_orden_compra WHERE t_entrega = 'Domicilio' AND recepcion_mercancia is NULL";
 $Rpedidos = $pedidos->query($sql01) or trigger_error($pedidos->error);
 $Npedidos= $pedidos->affected_rows;
 //echo $Npedidos;
  if ($Npedidos == 0) {
    
    print "<script>alert(\"No hay ordenes para hacer la recepción de mercancía!\");window.location='registro_orden_compra.php';</script>";
  }
 $pedidos->close();
...
<head>
  ...
  <title>Registro recepción de mercancía</title>
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Registro recepción de mercancía por domicilio</h3>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                <div class="x_title">
                  <h2>Formulario de recepción de mercancía:</h2>
                ...
                <!-- formulario de actualizacion de clientes -->
                  ...
                  <form id="demo-form2"  data-parsley-validate novalidate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="php/e_registro_recepcion_domicilio.php">
                    ...
                    <div class="numero_pedido">
                      ...
                      <label for="orden_compra" class="control-label col-md-3 col-sm-3 col-xs-12"># Orden de compra</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single01 form-control" required="" id="numero_pedido" name="orden_compra">

                          <option value="">Seleccione</option>
                            <?php 
                                  while ($z=$Rpedidos ->fetch_array()) {
                                    echo "<option value='$z[numero_orden_compra]'>$z[numero_orden_compra] - $z[cardname] - $z[cardcode] - $z[t_compra] $z[numero_pedido]</option>";
                    ...
                    <div class="item form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardname">Nombre encargado de la entrega
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="autocomplete-custom-append" required="" name="cardname" data-parsley-minlength="5" class="form-control col-md-7 col-xs-12 text-uppercase" placeholder="Pepito Pérez" style="float: left;padding-left: 40px;" />
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single02 form-control" required="" id="t_identificacion" name="t_identificacion">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="numero_identificacion" required="" name="numero_identificacion"  placeholder="860528792" data-parsley-minlength="4" class="form-control col-md-7 col-xs-12 has-feedback-left">
                        <span class="fa fa-list-ol form-control-feedback left" aria-hidden="true"></span>
                      </div>
                   </div>

                  <div class="item form-group">
                      <label for="N_encargado" class="control-label col-md-3 col-sm-3 col-xs-12">Nombre encargado recepción</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
