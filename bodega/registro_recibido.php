...
//traer pedidos
 ...
 //$sql01 = "SELECT id,cliente,cod_cliente,numero_pedido,n_cajas FROM intranet_registro_pedido WHERE zona <> 'TRANSPORTADORA' AND recibido is NULL AND fecha > '2016/05/25' AND entransito = '1' AND entregado = '1'";
   $sql01 = "SELECT id,cliente,cod_cliente,numero_pedido,n_cajas FROM intranet_registro_pedido WHERE zona <> 'TRANSPORTADORA' AND recibido is NULL AND fecha > '2016/05/25' AND entransito = '1' AND entregado = '1'";
...
<head>
  ...
  <title>Registro de recibido</title>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                ...
                <!-- formulario de actualizacion de clientes -->
                  ...
                  <form id="demo-form2" data-parsley-validate novalidate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="php/e_recibido.php">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single01 form-control" required="" id="numero_pedido" name="numero_pedido">

                          <option value="">Seleccione</option>
                            <?php 
                                  while ($z=$Rpedidos ->fetch_array()) {
                                    echo "<option value='$z[numero_pedido]'>$z[numero_pedido] - $z[cliente] - $z[n_cajas]</option>";
                    ...
                    <div class="item form-group">
                      <label for="encargado_transporte" class="control-label col-md-3 col-sm-3 col-xs-12">Encargado de transporte (entrega)</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="select2_single02 form-control" required="" id="encargado_transporte" name="encargado_transporte">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".select2_single02").select2({
        placeholder: "Seleccione encargado de transporte (entrega)"
      });
