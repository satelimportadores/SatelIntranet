...
<head>
 ...
 <script type="text/javascript" src="js/registro_cheques_tabla.js"></script>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                ...
                <!-- contenido -->
                	...
                	<div class="col-md-12 text-center bg-info"><h4>Para Consignar</h4></div>
                    <div class="col-md-12 text-center bg-info" id="por_consig"></div>
                    <div class="col-md-12 text-center bg-success"><h4>Consignados</h4></div>
                    <div class="col-md-12 text-center bg-success" id="consig"></div>
                    <div class="col-md-12 text-center bg-danger"><h4>Devueltos</h4></div>
                    <div class="col-md-12 text-center bg-danger" id="dev"></div>
                    <div class="col-md-12 text-center bg-primary"><h4>Efectivos</h4></div>
                    <div class="col-md-12 text-center bg-primary" id="efect"></div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" id="btn" data-dismiss="modal"></button>
                        <button type="button" onclick="save()" class="btn btn-primary" id="btn2"></button>
                      </div>
                    </div>
                  </div>
                </div>
