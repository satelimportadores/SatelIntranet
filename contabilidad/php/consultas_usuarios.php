...
$query = "select id,nombre,apellido from intranet_usuarios where nivel_permisos != 1 and activo = 1";
...
include('class.conexion.php');
$usuarios = new conexion;
$query2 = "select id,nombre,apellido from intranet_usuarios where nivel_permisos = 1 and activo = 1";
