          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:auto;">
                ...
                <div class="col-md-12 text-center"><h4>Para Consignar</h4></div>
                    <div class="col-md-12 text-center" id="por_consig"></div>
                    <div class="col-md-12 text-center"><h4>Consignados</h4></div>
                    <div class="col-md-12 text-center" id="consig"></div>
                    <div class="col-md-12 text-center"><h4>Devueltos</h4></div>
                    <div class="col-md-12 text-center" id="dev"></div>
                    <div class="col-md-12 text-center"><h4>Efectivos</h4></div>
                    <div class="col-md-12 text-center" id="efect"></div>
